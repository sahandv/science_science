...
fname = dir_root+'Corpus/cora-classify/cora/models/doc2vec 300D dm=1 window=10'
model.save(fname)
...
X_df = pd.DataFrame(X)
X_df.to_csv(dir_root+'Corpus/cora-classify/cora/embeddings/doc2vec 300D dm=1 window=10',index=False)