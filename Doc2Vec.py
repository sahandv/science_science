...
texts = pd.read_csv(dir_root+'Corpus/cora-classify/cora/clean/single_component_small/abstract_title all-lem',names=['abstract'])['abstract'].values.tolist()
...
fname = dir_root+'Corpus/cora-classify/cora/models/single_component_small/doc2vec 300D dm=1 window=10'
model.save(fname)
...
X_df = pd.DataFrame(X)
X_df.to_csv(dir_root+'Corpus/cora-classify/cora/embeddings/single_component_small/doc2vec 300D dm=1 window=10',index=False)