...
data_path_rel = '/mnt/16A4A9BCA4A99EAD/GoogleDrive/Data/Corpus/CS WoS/raw/all-cats.csv'
...
root_dir = '/mnt/16A4A9BCA4A99EAD/GoogleDrive/Data/Corpus/CS WoS/'
subdir = 'processed/' # no_lemmatization_no_stopwords

data_full_relevant = data_full_relevant[pd.notnull(data_full_relevant['TI'])]
data_full_relevant = data_full_relevant[pd.notnull(data_full_relevant['AB'])]
...
if MAKE_SENTENCE_CORPUS_ADVANCED is True:    
    ...
    sentence_df.to_csv(root_dir+subdir+'sentences abstract-title',index=False,header=True)
